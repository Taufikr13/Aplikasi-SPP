...
AND tb_siswa.id_kelas=tb_kelas.id_kelas AND tb_pembayaran.id_spp=tb_spp.id_spp AND tb_pembayaran.id_petugas=tb_petugas.id_petugas AND tb_pembayaran.id_siswa='$id_siswa' ORDER BY tgl_bayar DESC");
?>
